    ...
    for t in tweets:
        ...
        if('user' in tweet):
            ...
            if(user_id not in user_dict):   
               # print "adding followers count for user:",user_id,user['followers_count']
                user_dict[user_id] = int(user['followers_count'])
                #friends_count
...
def plot_graph():
    ...
    ax.set_title('CDF of Number of Followers of Users');
    ...
    plt.xlabel(' # Followers of Users',weight = "bold" ,fontsize = 10)
    ax.set_xlim(00, 2000)  
    #ax.set_ylim(0,1.1);
    ...
    plt.savefig("total_followers_cdf_"+"_"+file_time+"_linestyle"+".pdf");
